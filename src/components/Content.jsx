      ...
      <div className="content-profile">
        ...
        >
          ...
          <div className="profile-header" style={{
            display: "flex",
            alignItems: "center",
            borderBottom: theme === "dark" ? "1px solid #30363d" : "1px solid #e1e4e8",
            paddingBottom: "20px",
            marginBottom: "20px"
          }}>
            {avatarUrl && <img src={avatarUrl} alt="avatar" style={{ width: "120px", borderRadius: "50%", marginRight: "25px" }} />}
            <div>
              <h2>{userData.profile.name}</h2>
              <p style={{ fontStyle: "italic", margin: "5px 0" }}>{userData.profile.bio}</p>
              <p style={{ fontSize: "0.9em", margin: "5px 0" }}>
                <b>Seguidores:</b> {userData.profile.followers} • <b>Seguindo:</b> {userData.profile.following} • <b>Repos:</b> {userData.profile.public_repos}
              </p>
            </div>
          </div>
          ...
          <div className="top-repos" style={{ marginBottom: "20px" }}>
            <h3 style={{ borderBottom: theme === "dark" ? "1px solid #30363d" : "1px solid #e1e4e8", paddingBottom: "10px" }}>Top Repositórios ⭐</h3>
            <ul style={{ listStyle: "none", padding: 0 }}>
              {userData.top_repos.map(repo => (
                <li key={repo.name} style={{
                  padding: "10px 0",
                  borderBottom: theme === "dark" ? "1px solid #21262d" : "1px solid #e1e4e8"
                }}>
                  <a href={repo.html_url} target="_blank" rel="noreferrer" style={{
                    color: theme === "dark" ? "#58a6ff" : "#0969da",
                    textDecoration: "none",
                    fontWeight: "bold"
                  }}>{repo.name}</a> - ⭐ {repo.stars}
                </li>
              ))}
            </ul>
          </div>
          ...
          {userData.readme && (
            <div className="readme" style={{ marginTop: "20px" }}>
              <h3 style={{ borderBottom: theme === "dark" ? "1px solid #30363d" : "1px solid #e1e4e8", paddingBottom: "10px" }}>README</h3>
              <div style={{
